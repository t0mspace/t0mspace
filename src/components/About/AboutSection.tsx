function AboutSection() {
  return (
    <div id={"about"} className="about-section max-w-3xl mx-auto">
      ...
      <div className="overflow-y-scroll max-h-96 p-8 text-gray-200 bg-slate-100/100 bg-opacity-100 dark:bg-slate-700/30 rounded-2xl text-lg font-medium leading-relaxed">
