    ...
    <div id="projects" className="projects-section max-w-3xl mx-auto">
      ...
      <div className="flex flex-wrap gap-6">
        {projectsData.map((project, index) => (
          <div
            key={index}
            className="bg-black/.9 backdrop-blur-xl p-8 text-gray-200 custom-background bg-opacity-100 dark:bg-slate-700/30 rounded-2xl transform duration-300 cursor-pointer flex flex-col justify-between"
          >
            <header>
